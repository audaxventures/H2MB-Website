    ...
    >
      <defs>
        <linearGradient id="sky" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#061532" />
          <stop offset="100%" stopColor="#091e49" />
        </linearGradient>
        <linearGradient id="field-far" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#0d2b68" />
          <stop offset="100%" stopColor="#091e49" />
        </linearGradient>
      </defs>
      <rect width="1600" height="900" fill="url(#sky)" />
      <circle cx="1260" cy="230" r="120" fill="#497b37" opacity="0.16" />
      <circle cx="1260" cy="230" r="60" fill="#5e9e47" opacity="0.22" />
      <path d="M0 620 C 260 560, 520 600, 800 560 C 1080 520, 1340 580, 1600 540 L1600 900 L0 900 Z" fill="url(#field-far)" opacity="0.8" />
      <path d="M0 700 C 300 660, 560 720, 900 680 C 1180 650, 1400 700, 1600 660 L1600 900 L0 900 Z" fill="#061532" />
      <g stroke="#78b861" strokeOpacity="0.3" strokeWidth="1">
        <line x1="0" y1="760" x2="1600" y2="740" />
        <line x1="0" y1="800" x2="1600" y2="785" />
      </g>
      <g stroke="#e1e6e3" strokeOpacity="0.35" strokeWidth="2">
