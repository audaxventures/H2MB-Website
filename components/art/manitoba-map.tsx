  ...
  return (
    ...
    >
      <path
        ...
        strokeWidth="2"
      />
      <g stroke="#497b37" strokeWidth="2" strokeDasharray="6 8" strokeLinecap="round" opacity="0.85">
        <line x1="300" y1="10" x2="300" y2="610" />
        <line x1="20" y1="330" x2="580" y2="330" />
      </g>
      <circle cx="300" cy="330" r="9" fill="#497b37" />
      <circle cx="300" cy="330" r="18" fill="none" stroke="#497b37" strokeWidth="1.5" opacity="0.6" />
      <text
        x="320"
        y="325"
        fontSize="20"
